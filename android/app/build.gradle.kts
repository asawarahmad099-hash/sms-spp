...
android {
    ...
    defaultConfig {
        ...
        applicationId = "com.smsplatform.sms_gateway"
        // You can update the following values to match your application needs.
        // For more information, see: https://flutter.dev/to/review-gradle-config.
        // 23 (Marshmallow) — earliest API with the modern runtime-permission
        // model that SEND_SMS/READ_PHONE_STATE need; flutter_foreground_task
        // and every package here support it comfortably.
